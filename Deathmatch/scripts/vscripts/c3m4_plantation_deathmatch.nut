...
Map_InitialPlayerSpawns <- [PlayerSpawn(Vector(1786, 680, 128), QAngle(0, 90, 0)), PlayerSpawn(Vector(1729, 676, 129), QAngle(0, 90, 0)), PlayerSpawn(Vector(1639, 673, -130), QAngle(0, 90, 0)), PlayerSpawn(Vector(1579, 681, 129), QAngle(0, 90, 0))]
